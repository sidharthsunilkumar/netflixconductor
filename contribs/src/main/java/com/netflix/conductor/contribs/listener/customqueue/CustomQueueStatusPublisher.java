 ...
 */
public class CustomQueueStatusPublisher implements WorkflowStatusListener {

    private static final Logger LOGGER = LoggerFactory.getLogger(CustomQueueStatusPublisher.class);
    ...
    public CustomQueueStatusPublisher(QueueDAO queueDAO, ObjectMapper objectMapper,
        CustomQueueStatusPublisherProperties properties) {
    ...
    public void onWorkflowCompleted(Workflow workflow) {   	
    	...
    	System.out.println("workflow completed - from custom Q");
    ...
    public void onWorkflowTerminated(Workflow workflow) {
    	System.out.println("workflow terminated - from custom Q");
